                    ...
                    <div className="row y-gap-40 justify-between xl:justify-start">
                        <div className="col-xl-2 col-lg-4 col-sm-6">
                            ...
                            <div className="mt-30">
                                ...
                                <a href="#" className="text-18 fw-500 text-blue-1 mt-5">+(1) 123 456 7890</a>
                            </div>
                        ...
                        <div className="col-xl-2 col-lg-4 col-sm-6">
                            ...
                            <div className="d-flex items-center px-20 py-10 rounded-4 border-light">
                                <div className="icon-apple text-24"></div>
                                <div className="ml-20">
                                    <div className="text-14 text-light-1">Download on the</div>
                                    <div className="text-15 lh-1 fw-500">Apple Store</div>
                                </div>
                            </div>

                            <div className="d-flex items-center px-20 py-10 rounded-4 border-light mt-20">
                                <div className="icon-play-market text-24"></div>
                                <div className="ml-20">
                                    <div className="text-14 text-light-1">Get in on</div>
