...
//     <Html lang="en">
//       <Head />
//       <body className="preloader-visible">
//         <Main />
//         <NextScript />
//       </body>
//     </Html>
    ...
    <Html lang="en">
      ...
      <body >
        {/* <div class="preloader js-preloader">
          ...
          <div class="preloader__title">GoTripee</div>
        </div> */}
        <Main />
        <NextScript />

        {/* TEMPLATE JS - IMPORTANT: Load vendors.js BEFORE main.js */}
        {/* vendors.js contains ScrollMagic and other dependencies */}
        <script src="/assets/js/vendors.js"></script>
        {/* main.js uses ScrollMagic and Google Maps, so it must load after */}
