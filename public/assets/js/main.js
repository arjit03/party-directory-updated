(function () {
  ...
  // Expose initComponents globally so it can be called from Next.js pages
  ...
  // Expose RevealAnim globally so it can be called from Next.js pages
  ...
  const Events = (function () {
    function init() {
      ...
      targets.forEach((eventTarget) => {
        const attributesRaw = eventTarget.getAttribute('data-x-click')
